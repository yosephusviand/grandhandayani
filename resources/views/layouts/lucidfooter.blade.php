...
<script src="{{ asset('lucid/light') }}/assets/bundles/knob.bundle.js"></script> <!-- Jquery Knob-->
...
<script src="{{ asset('lucid/dark') }}/assets/bundles/mainscripts.bundle.js"></script>
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
{{-- <script src="{{ asset('lucid/dark') }}/assets/js/index.js"></script> --}}
</body>
